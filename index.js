...
card.forEach((curCard)=>{
    curCard.addEventListener("click", function(){
        ...
        div.innerHTML=`
         ...
         <p>Hospital offers advanced care for chest and respiratory diseases, including lung transplants, minimally invasive surgeries, and comprehensive pulmonary care with a dedicated team of specialists</p>
         </div>
        `
